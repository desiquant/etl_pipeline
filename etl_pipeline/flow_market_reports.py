...
from etl_pipeline.utils import sync_s3,number_of_new_entries,update_csv_with_latest_dates
...
async def nifty_50_announcements(source: str):
    ...
    update_csv_with_latest_dates(local_dir="./data/s3/announcements/bse",file_path="./scraper_metaInfo/latest_dates/latest_Announcementdate.csv")
...
async def create_announcements_artifact():
    artifact_dict = number_of_new_entries(local_dir="./data/s3/announcements/bse",file_path="./scraper_metaInfo/latest_dates/latest_Announcementdate.csv")
